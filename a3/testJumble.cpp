...
void testJumble() {
    ...
    cout << "\nNothing should appear (default constructor initializes fields to 0)" << endl;

        // test main constructor for three difficulties
    cout << "\nTesting main constructor:" << endl;
    cout << "\nDifficulty: hard" << endl;
    JumblePuzzle jp6("DIFFICULT", "hard");
    showJumble(jp6.getJumble(), jp6.getSize());

    cout << "\nDifficulty: medium" << endl;
    JumblePuzzle jp7("MEDIUM", "medium");
    showJumble(jp7.getJumble(), jp7.getSize());

    cout << "\nDifficulty: easy" << endl;
    JumblePuzzle jp8("EASY", "easy");
    showJumble(jp8.getJumble(), jp8.getSize());

    // test accessors
    cout << "\nTesting accessors for above puzzle" << endl;
    cout << "\nSize accessor: " << jp8.getSize() << endl;
    cout << "\nRow position accessor: " << jp8.getRowPos() << endl;
    cout << "\nColumn position accessor: " << jp8.getColPos() << endl;
    cout << "\nDirection accessor: " << jp8.getDirection() << endl;
    cout << "\nJumble word accessor: " << jp8.getJumble() << endl;

    // test exception class
        // test for word out of bounds exception
    try {
        cout << "\nTesting for difficulty: impossible" << endl;
        JumblePuzzle jp9("WORD", "impossible");
    } catch (BadJumbleException &e) {
        cout << "Exception message should indicate illegal difficulty: " << e.what() << endl;
    }

        // test for difficulty out of bounds exception
    try {
        cout << "\nTesting for word: wayTooLong" << endl;
        JumblePuzzle jp10("wayTooLong", "easy");
    } catch (BadJumbleException &e) {
        cout << "Exception message should indicate illegal word: " << e.what() << endl;
    }
